...
async function handleCourseSelect(interaction) {
    ...
    const roles = [
        { label: "Y1", description: "Year 1 Student", value: "1365651181883494462" },
        { label: "Y2", description: "Year 2 Student", value: "1365651256160423996" },
        { label: "Y3", description: "Year 3 Student", value: "1365651293414227968" },
    ];
...
async function handleModalSubmit(interaction) {
    ...
    try {
        ...
        const verifiedRoleId = '1365716315012333670' // TODO: make variable
        ...
        const channel = await client.channels.fetch('1365607503634894900');
        channel.send({ content: `**[VERIFICATION]** <@${userId}> NAME: **${name}** ROLE: **<@&${roleId}>** COURSE: **${course}**`, flags: [ 4096 ]})
    } catch (error) {
